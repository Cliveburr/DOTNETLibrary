...
{
    public class ActionParentRun : ActionTypesBase
    {
        public ActionParentRun(Action action)
            : base(action)
        {
        }
        ...
        public override FowardRunResult FowardRun(CommandContext ctx)
        {
            ...
            }, $"ActionParentRun in wrong status to Cursor! {Action.ActionId}-{Action.Label}");

            Assert.MustFalse(Action.WithCursor, $"ActionParentRun already with Cursor! {Action.ActionId}-{Action.Label}");
            ...
            else
            {
                ...
                ctx.Effects.Add(new CommandEffect(ComandEffectType.ActionUpdateParentRunToRun, Action));
        ...
        {
            Assert.MustTrue(Action.WithCursor, $"ActionParentRun in without cursor to Run! {Action.ActionId}-{Action.Label}");

            Assert.Enum.In(Action.Status, new[] {
                ActionStatus.Waiting,
                ActionStatus.Stopped,
                ActionStatus.Error
            }, $"ActionParentRun in wrong status to Run! {Action.ActionId}-{Action.Label}");
        ...
        {
            throw new RunnerException("ActionParentRun shound't never run from back!");
        }
        ...
        public override void SetRunning(CommandContext ctx)
        {
            Assert.Enum.In(Action.Status, new[] {
                ActionStatus.ToRun
            }, $"ActionParentRun in wrong status to Running! {Action.ActionId}-{Action.Label}");
        ...
        {
            throw new RunnerException("ActionParentRun shound't never running from back!");
        }
        ...
        public override void SetCompleted(CommandContext ctx)
        {
            Assert.Enum.In(Action.Status, new[] {
                ...
                ActionStatus.ToStop
            }, $"ActionParentRun in wrong status to Completed! {Action.ActionId}-{Action.Label}");
        ...
        {
            throw new RunnerException("ActionParentRun shound't never completed from back!");
        }
        ...
        public override void SetError(CommandContext ctx)
        {
            Assert.Enum.In(Action.Status, new[] {
                ...
                ActionStatus.ToRun,
                ActionStatus.ToRun
            }, $"ActionParentRun in wrong status to Error! {Action.ActionId}-{Action.Label}");
        ...
        {
            throw new RunnerException("ActionParentRun shound't never error from back!");
        }
        ...
        public override void Stop(CommandContext ctx)
        {
            ...
            if (Action.Status == ActionStatus.Running)
            {
                ...
                ctx.Effects.Add(new CommandEffect(ComandEffectType.ActionUpdateParentRunToStop, Action));
        ...
        {
            throw new RunnerException("ActionParentRun shound't never stop from back!");
        }
        ...
        {
            throw new RunnerException("ActionParentRun shound't never stopped from back!");
        }
        ...
        public override void SetBreakPoint(CommandContext ctx)
        {
            Assert.Enum.In(Action.Status, new[] {
                ...
                ActionStatus.Stopped,
                ActionStatus.Error
            }, $"ActionParentRun in wrong status to set breakpoint! {Action.ActionId}-{Action.Label}");
        ...
        {
            throw new RunnerException("ActionParentRun shound't never breakpoint from back!");
        }
        ...
        {
            throw new RunnerException("ActionParentRun shound't never call build data from back!");
        }
    }
}
